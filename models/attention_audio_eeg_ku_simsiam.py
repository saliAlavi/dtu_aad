...
class EncoderBase(layers.Layer):
    def __init__(self, d_aecross=320,**kwargs):
        ...
        self.audio_encoder_m = AudioEncoder(source='audio_0_ds')
        self.audio_encoder_f = AudioEncoder(source='audio_1_ds')
...
class AttnCrossAudioEEGSimsiamKU(Model):
    def __init__(self, d_aecross=320):
        super(AttnCrossAudioEEGSimsiamKU, self).__init__()
    ...
    def train_step(self, data):
        ...
        with tf.GradientTape() as tape:
            ...
            data_0['audio_0_ds']=data_0['audio_0_ds'] + tf.random.normal(tf.shape(data_0['audio_0_ds']), mean=0, stddev=noise_std)
            data_0['audio_1_ds']=data_0['audio_1_ds'] + tf.random.normal(tf.shape(data_0['audio_1_ds']), mean=0, stddev=noise_std)

            data_1['eeg_csp'] =  data_1['eeg_csp'] + tf.random.normal(   tf.shape(data_1['eeg_csp']), mean=0,    stddev=noise_std)
            data_1['audio_0_ds']=data_1['audio_0_ds'] + tf.random.normal(tf.shape(data_1['audio_0_ds']), mean=0, stddev=noise_std)
            data_1['audio_1_ds']=data_1['audio_1_ds'] + tf.random.normal(tf.shape(data_1['audio_1_ds']), mean=0, stddev=noise_std)
    ...
    def call(self, data_inp, training=False, contrastive=False):
        ...
        data['audio_0_ds'] = self.normalizer_audio_m(data['audio_0_ds'])
        data['audio_1_ds'] = self.normalizer_audio_f(data['audio_1_ds'])
        ...
        if contrastive:
            if training:
                ...
                data['eeg_csp'] = data['eeg_csp'] + tf.random.normal(tf.shape(data['eeg_csp']), mean=0,
                                                                     stddev=noise_std)
                data['audio_0_ds'] = data['audio_0_ds'] + tf.random.normal(tf.shape(data['audio_0_ds']), mean=0,
                                                                           stddev=noise_std)
                data['audio_1_ds'] = data['audio_1_ds'] + tf.random.normal(tf.shape(data['audio_1_ds']), mean=0,
                                                                           stddev=noise_std)
