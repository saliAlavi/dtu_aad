...
All_val_acc = {}
Train_val_params={}
Current_dataset = 'dtu_td_cmaa_50ov_2s'
...
if __name__ == '__main__':
    ...
    dataset_names = ['kuleuven_50ov_05s']
    dataset_sub_names = [f'sub{i}' for i in range(10,17)]
        ...
        for dataset_sub_name in dataset_sub_names:
            ...
            for Curr_fold,(train_split, test_split) in enumerate(zip(train_splits, test_splits)):
                    for rep in range(reps):
                        ...
                        model = AttnCrossAudioEEGSimsiamKU(d_aecross=32)
