...
if __name__ == '__main__':
    ...
    dataset_sub_names = [f'sub{i}' for i in range(1,19)]+['all']+[f'all_e{i}' for i in range(1,19)]

    dataset_names = ['dtu_td_cmaa_50ov']
    dataset_sub_names = [f'all_e{i}' for i in range(17,19)]
