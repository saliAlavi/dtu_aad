...
class Builder(tfds.core.GeneratorBasedBuilder):
    ...
    BUILDER_CONFIGS = [
        BuilderConfigEEG(name='sub1', description='5 second splits, subject 1', subject=1, t_span=5),
        BuilderConfigEEG(name='sub2', description='5 second splits, subject 2', subject=2, t_span=5),
        BuilderConfigEEG(name='sub3', description='5 second splits, subject 3', subject=3, t_span=5),
        BuilderConfigEEG(name='sub4', description='5 second splits, subject 4', subject=4, t_span=5),
        BuilderConfigEEG(name='sub5', description='5 second splits, subject 5', subject=5, t_span=5),
        BuilderConfigEEG(name='sub6', description='5 second splits, subject 6', subject=6, t_span=5),
        BuilderConfigEEG(name='sub7', description='5 second splits, subject 7', subject=7, t_span=5),
        BuilderConfigEEG(name='sub8', description='5 second splits, subject 8', subject=8, t_span=5),
        BuilderConfigEEG(name='sub9', description='5 second splits, subject 9', subject=9, t_span=5),
        BuilderConfigEEG(name='sub10', description='5 second splits, subject 10', subject=10, t_span=5),
        BuilderConfigEEG(name='sub11', description='5 second splits, subject 11', subject=11, t_span=5),
        BuilderConfigEEG(name='sub12', description='5 second splits, subject 12', subject=12, t_span=5),
        BuilderConfigEEG(name='sub13', description='5 second splits, subject 13', subject=13, t_span=5),
        BuilderConfigEEG(name='sub14', description='5 second splits, subject 14', subject=14, t_span=5),
        BuilderConfigEEG(name='sub15', description='5 second splits, subject 15', subject=15, t_span=5),
        BuilderConfigEEG(name='sub16', description='5 second splits, subject 16', subject=16, t_span=5),
        BuilderConfigEEG(name='sub17', description='5 second splits, subject 17', subject=17, t_span=5),
        BuilderConfigEEG(name='sub18', description='5 second splits, subject 18', subject=18, t_span=5),
        BuilderConfigEEG(name='all', description='5 second splits, all subjects', subject=0, t_span=5),
        BuilderConfigEEG(name='all_e1', description='5 second splits, all subjects except 1', subject=-1, t_span=5),
        BuilderConfigEEG(name='all_e2', description='5 second splits, all subjects except 2', subject=-2, t_span=5),
        BuilderConfigEEG(name='all_e3', description='5 second splits, all subjects except 3', subject=-3, t_span=5),
        BuilderConfigEEG(name='all_e4', description='5 second splits, all subjects except 4', subject=-4, t_span=5),
        BuilderConfigEEG(name='all_e5', description='5 second splits, all subjects except 5', subject=-5, t_span=5),
        BuilderConfigEEG(name='all_e6', description='5 second splits, all subjects except 6', subject=-6, t_span=5),
        BuilderConfigEEG(name='all_e7', description='5 second splits, all subjects except 7', subject=-7, t_span=5),
        BuilderConfigEEG(name='all_e8', description='5 second splits, all subjects except 8', subject=-8, t_span=5),
        BuilderConfigEEG(name='all_e9', description='5 second splits, all subjects except 9', subject=-9, t_span=5),
        BuilderConfigEEG(name='all_e10', description='5 second splits, all subjects except 10', subject=-10, t_span=5),
        BuilderConfigEEG(name='all_e11', description='5 second splits, all subjects except 11', subject=-11, t_span=5),
        BuilderConfigEEG(name='all_e12', description='5 second splits, all subjects except 12', subject=-12, t_span=5),
        BuilderConfigEEG(name='all_e13', description='5 second splits, all subjects except 13', subject=-13, t_span=5),
        BuilderConfigEEG(name='all_e14', description='5 second splits, all subjects except 14', subject=-14, t_span=5),
        BuilderConfigEEG(name='all_e15', description='5 second splits, all subjects except 15', subject=-15, t_span=5),
        BuilderConfigEEG(name='all_e16', description='5 second splits, all subjects except 16', subject=-16, t_span=5),
        BuilderConfigEEG(name='all_e17', description='5 second splits, all subjects except 17', subject=-17, t_span=5),
        BuilderConfigEEG(name='all_e18', description='5 second splits, all subjects except 18', subject=-18, t_span=5),
    ...
    def _generate_examples(self,split):
        ...
        for subject in subjects:
            ...
            # print(f'eeg_all_reshaped.shape {eeg_all_reshaped.shape}')
            # print(f'tmp.shape {tmp.shape}')
            # print(eeg_all_reshaped[300,...])
            # print(tmp[300,...])
            # print(np.sum(eeg_all_reshaped==0))
            # assert (tmp == eeg_all_reshaped).all()
            ...
            audio_m_ds_all_reshaped = np.zeros((n_data*n_sects,T_SPAN*SR_DS_AUDIO))
            audio_f_ds_all_reshaped = np.zeros((n_data * n_sects, T_SPAN * SR_DS_AUDIO))
            audio_m_raw_all_reshaped = np.zeros((n_data * n_sects, T_SPAN * SR_AUDIO))
            audio_f_raw_all_reshaped = np.zeros((n_data * n_sects, T_SPAN * SR_AUDIO))
            for curr_data in range(n_data):
                for curr_sect in range(n_sects):
                    curr_ind = curr_data*n_sects+curr_sect

                    audio_m_ds_all_reshaped[curr_ind,...]=audio_m_ds_all[curr_data,curr_sect*STEP_SIZE_SDAUDIO:curr_sect*STEP_SIZE_SDAUDIO+T_SPAN*SR_DS_AUDIO]
                    audio_f_ds_all_reshaped[curr_ind,...]=audio_f_ds_all[curr_data,curr_sect*STEP_SIZE_SDAUDIO:curr_sect*STEP_SIZE_SDAUDIO+T_SPAN*SR_DS_AUDIO]
                    audio_m_raw_all_reshaped[curr_ind,...]=audio_m_raw_all[curr_data,curr_sect*STEP_SIZE_AUDIO:curr_sect*STEP_SIZE_AUDIO+T_SPAN*SR_AUDIO]
                    audio_f_raw_all_reshaped[curr_ind,...]=audio_f_raw_all[curr_data,curr_sect*STEP_SIZE_AUDIO:curr_sect*STEP_SIZE_AUDIO+T_SPAN*SR_AUDIO]

            if subject == 2:
                eeg_all_reshaped+=np.random.normal(0, 0.01)
            if subject == 10 or subject==11:
                eeg_all_reshaped += np.random.normal(0, 0.01)
