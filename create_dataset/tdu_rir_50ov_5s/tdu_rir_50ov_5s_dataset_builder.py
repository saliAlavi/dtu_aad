...
class BuilderConfigEEG(tfds.core.BuilderConfig):
    ...
    audio_left_sim_ds: Tuple[int,] = (int(SR_EEG * T_SPAN),)
    audio_right_sim_ds: Tuple[int,] = (int(SR_EEG * T_SPAN),)
    ...
    def _info(self) -> tfds.core.DatasetInfo:
        ...
        return tfds.core.DatasetInfo(
            ...
            features=tfds.features.FeaturesDict({
                ...
                'audio_left_sim_ds': tfds.features.Tensor(dtype=np.float32, shape=self._builder_config.audio_left_sim_ds),
                'audio_right_sim_ds': tfds.features.Tensor(dtype=np.float32, shape=self._builder_config.audio_right_sim_ds),
